                ...
                <div class="col-12">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                            ...
                            $querydosen = mysqli_query($konek, "select * from guru inner join users on guru.id_guru = users.id_users where id_guru = '$_SESSION[Id_User]'");
                            if ($querydosen == false) {
                                ...
                                <?php while ($user = mysqli_fetch_array($querydosen)) : ?>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input type="text" value="<?= $user['nama_guru'] ?>" class="form-control" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
