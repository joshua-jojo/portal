      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input name="tugas" required type="file" class="form-control" placeholder="pembahasan" />
          </div>
          ...
          <div class="form-group">
            ...
            <input name="tanggal" required type="date" class="form-control" placeholder="batas akhir">
          </div>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select name="siswa" class="form-control">
              ...
              $sql = $konek->query("SELECT * FROM siswa INNER JOIN kelas on kelas.id_kelas = siswa.kelas where kelas.id_kelas = '$kelas'");
              while ($data = $sql->fetch_assoc()) {
