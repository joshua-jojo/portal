...
mysqli_query($konek, "INSERT INTO `forum`( `id_comment_parent`,`comment`, `nama_user`, `status`, `id_pelajaran`, `id_kelas`) VALUES ('$komen_id','$komen','$nama_pengirim','guru','$pelajaran','$kelas')");
