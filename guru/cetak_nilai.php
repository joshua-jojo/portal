              ...
              <div class="col-12">
                <div class="">
                  ...
                  <table id="tabel" class="table align-items-center mb-3">
                    ...
                    <tbody>
                      <?php
                      $querynilai = mysqli_query($konek, "select * from nilai nilai inner join jadwal on nilai.id_pelajaran = jadwal.id_pelajaran inner join pelajaran on nilai.id_pelajaran = pelajaran.id_pelajaran inner join siswa on nilai.id_siswa = siswa.nis where nilai.id_pelajaran  = '$_POST[pelajaran]' and nama_kelas = '$_POST[kelas]' group by nilai.id_siswa;");
