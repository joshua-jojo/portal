                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <table id="data" class="table table-bordered table-striped table-scalable">
                                    ...
                                    $querynilai = mysqli_query($konek, "select * from nilai_siswa inner join siswa on nilai_siswa.kode_siswa = siswa.nis inner join pelajaran on nilai_siswa.kode_pelajaran = pelajaran.kode_pelajaran where nilai_siswa.kode_pelajaran  = '$_POST[pelajaran]' and nama_kls = '$_POST[kelas]'");
                                    if ($querynilai == false) {
