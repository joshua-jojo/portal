                                        ...
                                        <table class="table align-items-center mb-3">
                                            ...
                                            <tbody>
                                                ...
                                                <?php if ($_POST['tanggal'] !== "") : ?>
                                                    <?php
                                                    // $querydosen = mysqli_query($konek, " select * from absensi inner join jadwal on absensi.id_pelajaran = jadwal.id_pelajaran inner join pelajaran on absensi.id_pelajaran = pelajaran.id_pelajaran inner join kelas on absensi.id_kelas = kelas.id_kelas where jadwal.id_guru='$_POST[namaGuru]' and absensi.id_pelajaran = '$_POST[pelajaran]' and absensi.id_kelas='$_POST[kelas]' and absensi.tanggal='$_POST[tanggal]' order by tanggal desc");
                                                    $querydosen = mysqli_query($konek, " select DISTINCT absensi.id_absensi, absensi.nama_siswa, absensi.id_kelas, jadwal.id_pelajaran, nama_kelas, nama_pelajaran, DATE_FORMAT(tanggal,'%d-%m-%Y') as tanggal, status from absensi inner join jadwal on absensi.id_pelajaran = jadwal.id_pelajaran inner join pelajaran on absensi.id_pelajaran = pelajaran.id_pelajaran inner join kelas on absensi.id_kelas = kelas.id_kelas where jadwal.id_guru='$_POST[namaGuru]' and absensi.id_pelajaran = '$_POST[pelajaran]' and absensi.id_kelas='$_POST[kelas]' and absensi.tanggal='$_POST[tanggal]' order by tanggal desc");
                                                    if ($querydosen == false) {
