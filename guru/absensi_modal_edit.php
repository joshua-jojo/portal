...
$querymhs = mysqli_query($konek, " select * from presensi inner join kelas on presensi.kode_kelas = kelas.id_kelas inner join pelajaran on presensi.id_pelajaran = pelajaran.kode_pelajaran WHERE id_presensi='$id'");
if($querymhs == false){
								...
								<div class="form-group">
									<label>id absen</label>
										<div class="input-group">
											...
											<input name="id" type="text" class="form-control" placeholder="siswa" value="<?php echo $abs['id_presensi']?>" readonly/>
										</div>
								</div>
								<div class="form-group">
									<label>siswa</label>
										<div class="input-group">
											...
											<input name="siswa" type="text" class="form-control" placeholder="Nama siswa" value="<?php echo $abs['nama']?>" required/>
										</div>
								</div>
								<div class="form-group">
									<label>Tanggal</label>
									...
									<label>Kelas</label>
										<div class="input-group">
											...
											<select name="kelas" class="form-control" required>
												...
												<?php
												echo "<option value='$abs[kode_kelas]' selected>$abs[nama_kelas]</option>";
									...
									<label>status</label>
										<div class="input-group">
											...
											<select name="status" class="form-control" required>
												<?php 	echo "<option value='$abs[statuss]' selected>$abs[statuss]</option>";?>
