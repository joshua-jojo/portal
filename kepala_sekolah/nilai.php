              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <h5 class="font-weight-bolder">Data Nilai Kelas Anda</h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <h5 class="font-weight-bolder">Data Nilai Semua Kelas</h5>
                  </div>
                </div>
                ...
                <div class="table-responsive">
                  <table id="tabel" class="table align-items-center mb-3">
                    ...
                    <tbody>
                      <?php
                      // $querynilai = mysqli_query($konek, "select * from nilai nilai inner join jadwal on nilai.id_pelajaran = jadwal.id_pelajaran inner join pelajaran on nilai.id_pelajaran = pelajaran.id_pelajaran inner join siswa on nilai.id_siswa = siswa.nis group by nilai.id_siswa;");
                      $querynilai = mysqli_query($konek, "select * from nilai inner join pelajaran on nilai.id_pelajaran = pelajaran.id_pelajaran inner join siswa on nilai.id_siswa = siswa.nis order by nilai.id_siswa asc");
                      if ($querynilai == false) {
                        die("Terjadi Kesalahan : " . mysqli_error($konek));
                      }
                      ?>
