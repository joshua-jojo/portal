...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							...
							<div class="box-body">
								<a href="#"><button class="btn btn-primary" type="button" data-target="#ModalAdd" data-toggle="modal">Tambah pengumuman</button></a>
								<br></br>
								<table id="data" class="table table-bordered table-striped table-scalable">
									...
									<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href=\"unduh_pengumuman.php?file=$pengumuman[lampiran]\">$pengumuman[lampiran]</a></td>
                                            <td>
                                                <a href='#' class='open_modal' id='$pengumuman[id_pengumuman]'>Edit</a> |
                                                <a href='#' onClick='confirm_delete(\"delete_pengumuman.php?kode_pengumuman=$pengumuman[id_pengumuman]\")'>Delete</a>
                                            </td>
                                        </tr>";
											$no++;
										}
							...
							<form action="pengumuman_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input name="tanggal" type="date" class="form-control" value="<?php echo $tanggal_upload ?>" />
									</div>
								</div>
			...
			<div id="ModalEditPengumuman" class="modal fade" tabindex="-1" role="dialog">
