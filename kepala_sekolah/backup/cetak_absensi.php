                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <table id="data" class="table table-bordered table-striped table-scalable">
                                    ...
                                    <?php
                                    if ($_POST['tanggal'] !== "") {
                                        $querydosen = mysqli_query($konek, " select DISTINCT id_presensi,nama,kode_kelas,jadwal.id_pelajaran,nama_kelas, nama_pelajaran,DATE_FORMAT(tanggal,'%d-%m-%Y') as tgl,statuss from presensi inner join jadwal on presensi.id_pelajaran = jadwal.id_pelajaran inner join pelajaran on presensi.id_pelajaran = pelajaran.kode_pelajaran inner join kelas on presensi.kode_kelas = kelas.id_kelas where presensi.id_pelajaran = '$_POST[pelajaran]' and presensi.kode_kelas='$_POST[kelas]' and presensi.tanggal='$_POST[tanggal]' order by nama asc");
                                        if ($querydosen == false) {
                                        ...
                                        $querydosen = mysqli_query($konek, " select DISTINCT id_presensi,nama,kode_kelas,jadwal.id_pelajaran,nama_kelas, nama_pelajaran,DATE_FORMAT(tanggal,'%d-%m-%Y') as tanggal,statuss from presensi inner join jadwal on presensi.id_pelajaran = jadwal.id_pelajaran inner join pelajaran on presensi.id_pelajaran = pelajaran.kode_pelajaran inner join kelas on presensi.kode_kelas = kelas.id_kelas where presensi.id_pelajaran = '$_POST[pelajaran]' and presensi.kode_kelas='$_POST[kelas]' order by nama asc");
                                        if ($querydosen == false) {
                                            die("Terjadi Kesalahan : " . mysqli_error($konek));
                                        }
                                        while ($absen = mysqli_fetch_array($querydosen)) {
