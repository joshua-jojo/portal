...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <form action="cetak_absensi.php" method="post" class="mt-5" style="float:right; width:500px">
                <div class=" form-group col-md-5" style="margin-left: 250px;">
                    <label>Cetak Absen</label>
                    <div class="input-group">


                        <select name="pelajaran" class="form-control" reuqired>
                            <option value="">pilih pelajaran</option>
                            <?php
                            ...
                            <div class="box-body">
                                ...
                                <table id="data" class="table table-bordered table-striped table-scalable">
                                    ...
                                    if (empty($_POST['pelajaran'])) {
                                        echo "<div class='alert alert-info'>silahkan pilih kelas terlebih dahulu</div>";
                                    } else {
