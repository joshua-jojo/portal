  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="box-body">
        ...
        <br></br>
        <h3>
          <div class="alert alert-info" style="padding: 20px; border-radius:10px">Selamat datang Kepala sekolah , <?php echo $_SESSION['Username'] ?></div>
          <table id="data" class="table table-bordered table-striped table-scalable" border="1">
