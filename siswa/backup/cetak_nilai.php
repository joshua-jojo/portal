                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <table id="data" class="table table-bordered table-striped table-scalable">
                                    ...
                                    $querynilai = mysqli_query($konek, "select kode_siswa, nama_kls, kode_nilai,Nama_siswa, nama_pelajaran, tugas,uts,uas from nilai_siswa inner join pelajaran on nilai_siswa.kode_pelajaran = pelajaran.kode_pelajaran inner join siswa on nilai_siswa.kode_siswa = siswa.nis where kode_siswa = '$_SESSION[Id_User]'");
                                    if ($querynilai == false) {
