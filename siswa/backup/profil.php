      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
					...
					<li><a href="jadwal.php">Jadwal</span></a></li>
					<li><a href="nilai.php">Nilai</span></a></li>
								...
								<label>Password</label>
									...
									<div class="input-group">
                                        <?php
											$sql = $konek->query("select * from pengguna where Id_User = '$_SESSION[Id_User]'");
											while ($data = $sql->fetch_assoc()) {
												echo "<input type='password' name='password' class='form-control checkboxx' value='$data[Password]' minlength='6' maxlength='8' required> ";
											}
										?>
                                        <div class="input-group-addon">
